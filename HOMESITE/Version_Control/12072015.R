...
write_csv(submission, "D:\\kaggle\\HOMESITE\\submission\\12082015\\12082015_5.csv")


time_taken <- Sys.time() - start

xgb.save(model = clf, fname = "D:\\kaggle\\HOMESITE\\models\\12092015.R")
...
write_csv(submission, "D:\\kaggle\\HOMESITE\\submission\\12082015\\12082015_3.csv")

imp_mat <- xgb.importance(feature_names = feature.names, model = clf)

write_csv(tmp, "D:\\kaggle\\HOMESITE\\tmp.csv")
