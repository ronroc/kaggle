...
# start iteration loop---------------------------------------------------------------------------------
  ...
  for (sk in skf) {
    ...
    localH2O <- h2o.init(nthreads = 36, max_mem_size = '12g', assertion = F)
...
write_csv(data.frame(dataset_blend_train), "D:\\kaggle\\HOMESITE\\blend\\bag\\gbm\\blend_train_gbm_02052016.csv")

write_csv(data.frame(dataset_blend_test), "D:\\kaggle\\HOMESITE\\blend\\bag\\gbm\\blend_test_gbm_02052016.csv")
