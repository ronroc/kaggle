...
write_csv(data.frame(dataset_blend_train), "D:\\kaggle\\PRUDENTIAL\\blend\\bag\\xgb\\train\\blend_train_params_6.csv")

write_csv(data.frame(dataset_blend_test), "D:\\kaggle\\PRUDENTIAL\\blend\\bag\\xgb\\test\\blend_test_params_6.csv")

importance_matrix <- xgb.importance(feature_names = names(train), model = mod)

write_csv(data.frame(importance_matrix), "D:\\kaggle\\PRUDENTIAL\\Data\\imp_mat_02142016_9.csv") 