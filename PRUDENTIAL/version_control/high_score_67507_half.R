...
write_csv(as.data.frame(dataset_blend_test), "D:\\kaggle\\PRUDENTIAL\\blend\\blend_test_01232016_1")

write_csv(as.data.frame(dataset_blend_train), "D:\\kaggle\\PRUDENTIAL\\blend\\blend_train_01232016_1")
