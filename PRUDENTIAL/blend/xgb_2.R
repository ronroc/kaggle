...
write_csv(data.frame(dataset_blend_train), "D:\\kaggle\\PRUDENTIAL\\blend\\bag\\xgb\\blend_train_xgb_02142016.csv")

write_csv(data.frame(dataset_blend_test), "D:\\kaggle\\PRUDENTIAL\\blend\\bag\\xgb\\blend_test_xgb_02142016.csv")

importance_matrix <- xgb.importance(feature_names = names(train), model = mod)

write_csv(data.frame(importance_matrix), "D:\\kaggle\\PRUDENTIAL\\Data\\imp_mat_02142016.csv") 